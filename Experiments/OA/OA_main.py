...
from lib.utils import ensure_dir,select_device,set_parameters                                                                    # noqa
##%%
...
for silo in ['CamCAN', 'SALD', 'eNKI']:
    ...
    # Train the model
    train_losses, val_losses, plotting_scaler, best_model = train_centralmodel(train_path, max_epochs, DEVICE)
