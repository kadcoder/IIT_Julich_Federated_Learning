...
from lib.data_utils import preprocess                                                               # noqa
from lib.training import train_globalgrads, train_globalmodel                                       # noqa
from lib.evaluation import evaluate_model, predict_age, compute_validation_loss                                              # noqa
from lib.harmonize import harmonize_localsilos                                                      # noqa
...
initial_results_path = os.path.join(project_dir, f'Experiments_1_2_eNKI/post-H-m4/results_post-H-m4/post-H-m4_l{federated_epochs}.csv')
...
csv_loss_path = os.path.join(
    project_dir,
    f'Experiments_1_2_eNKI/post-H-m4/results_post-H-m4/train_val_loss_localsilo_l{federated_epochs}.csv'
)
...
with open(csv_loss_path, mode='w', newline='') as f2:
    ...
    for epoch in range(Global_epoch):
        ...
        for silo in local_silos:
            ...
            grads, train_losses, val_losses, best_val_loss, best_model = train_globalgrads(
        ...
        #best_model_global = (best_global_loss + sum_loss) / len(all_silos)
...
results_age_path = os.path.join(project_dir, 'Experiments_1_2_eNKI/post-H-m4/results_post-H-m4/predictions')
...
plot_loss_curves(loss_history, project_dir, 'Experiments_1_2_eNKI/post-H-m4/results_post-H-m4/')  # Plotting function
