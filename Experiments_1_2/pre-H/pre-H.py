...
initial_results_path = os.path.join(project_dir, 'Experiments_1_2/pre-H/results_pre-H/pre-H_l15.csv')
...
csv_loss_path = os.path.join(project_dir, f'Experiments_1_2/pre-H/results_pre-H/train_val_loss_localsilo_l15.csv')
...
results_age_path = os.path.join(project_dir, 'Experiments_1_2/pre-H/results_pre-H/predictions')
...
plot_loss_curves(loss_history, project_dir, 'Experiments_1_2/pre-H/results_pre-H/')  # Plotting function
